...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected = -2.0598  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(2, 4)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = -0.2358  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(0, 5)
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = 0.1020  # This is APPROXIMATELY the correct answer.
