...
def run_test_count_cosines_from():
    ...
    #Test 2:
    expected = 3
    answer = count_cosines_from(4, 9, 0.15)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    #Test 3:
    expected = 3
    answer = count_cosines_from(6, 12, 0.31)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    #Test 4:
    expected = 2
    answer = count_cosines_from(8, 16, 0.21)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    #Test 5:
    expected = 4
    answer = count_cosines_from(5, 13, 0.55)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.76877  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 20)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 1.59286  # This is APPROXIMATELY the correct answer.
    ...
    # Test 4:
    expected = 0.37258
    answer = sum_unit_fractions_from(16, 22)
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
